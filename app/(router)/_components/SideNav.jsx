...
function SideNav() {
  ...
  return (
    <div className="p-5 bg-orange-400 shadow-sm border h-screen">
      ...
      <div className="mt-5">
        {menu.map((item, index) => (
          <div className="group flex gap-3 mt-2 p-3 text-[18px] items-center text-white cursor-pointer hover:bg-orange-500 hover:text-white rounded-md transition-all ease-in-out duration-200 ">
